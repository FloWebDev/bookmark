 ...
 */
final class Version20210430220356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, listing_id INTEGER DEFAULT NULL, title VARCHAR(512) NOT NULL, url VARCHAR(2048) NOT NULL, z INTEGER NOT NULL, note CLOB DEFAULT NULL, created_at DATETIME NOT NULL)');
