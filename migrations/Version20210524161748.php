 ...
 */
final class Version20210524161748 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE app_user ADD COLUMN slug VARCHAR(32) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_user AS SELECT id, username, password, email, role, created_at, connected_at, wallpaper FROM "app_user"');
        $this->addSql('DROP TABLE "app_user"');
        $this->addSql('CREATE TABLE "app_user" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(256) NOT NULL, role VARCHAR(32) NOT NULL, created_at DATETIME NOT NULL, connected_at DATETIME DEFAULT NULL, wallpaper VARCHAR(64) DEFAULT NULL)');
        $this->addSql('INSERT INTO "app_user" (id, username, password, email, role, created_at, connected_at, wallpaper) SELECT id, username, password, email, role, created_at, connected_at, wallpaper FROM __temp__app_user');
